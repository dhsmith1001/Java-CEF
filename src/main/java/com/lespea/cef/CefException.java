...
/**
 * Exception implementation specific to the java-cef module.
 */
public class CefException extends Exception
{
     ...
     * @since 0.0.2
     */
    public CefException(String message)
    {
        super(message);
    }
     ...
     * @since 0.0.2
     */
    public CefException(String message, Throwable cause)
    {
        super(message, cause);
    }

    /**
     * Constructs a new exception with the specified cause and a detail message of <tt>(cause==null ? null : cause.toString())</tt> (which
     * typically contains the class and detail message of <tt>cause</tt>).  This constructor is useful for exceptions that are little
     * more than wrappers for other throwables (for example, {@link java.security.PrivilegedActionException}).
     *
     * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method).  (A <tt>null</tt> value is
     *              permitted, and indicates that the cause is nonexistent or unknown.)
     * @since 0.0.2
     */
    public CefException(Throwable cause)
    {
        super(cause);
    }
     ...
     * @since 0.0.2
     */
    protected CefException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
    {
